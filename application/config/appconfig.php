...
define('CONTACTS_UPLOAD_DIR', str_replace("\\","/",FCPATH).'uploads/users/contacts/');
define('IMAGE_UPLOAD_DIR', str_replace("\\","/",FCPATH).'uploads/users/img/');
...
$config['mail_config']['smtp_host']	    = 'pod51022.outlook.com';
$config['mail_config']['smtp_user']	    = 'email@jayshreeanand.in';
$config['mail_config']['smtp_pass']	    = 'jay123';
...
$config['web_admin_email_id'] = 'email@jayshreeanand.in';
/************************* end email config ***************************/
